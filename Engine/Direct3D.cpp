...
namespace Direct3D
{
	...
	void InitShaderBundle()
	{
		...
		//SHADOW
		{
			...
			// ピクセルシェーダの作成（コンパイル）
			ID3DBlob* pCompilePS = NULL;
			D3DCompileFromFile(L"Shader/ShadowShader.hlsl", nullptr, nullptr, "PS", "ps_5_0", NULL, 0, &pCompilePS, NULL);
	...
	void BeginDraw()
	{
		...
		//背景の色
		float clearColor[4] = { 25 / 255.0f, 25 / 255.0f, 112 / 255.0f, 1.0f };//R,G,B,A
